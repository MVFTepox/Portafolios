export const MediaSocials = () => {
  return (
    <div className="fixed left-0 top-1/2 transform -translate-y-1/2 z-50 flex flex-col items-center gap-4 bg-white pl-8 p-4 rounded-r-4xl">
      <a href="https://www.facebook.com/Tepoxi" target="_blank" rel="Perfin de Facebook">
        <img
      ...
      <a href="https://www.linkedin.com/in/mario-valentin-fraire-tepox/" target="_blank" rel="Perfin de LinkedIn">
        <img
